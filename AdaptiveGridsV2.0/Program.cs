...
materials.Add("1", new Material(false, true, false, x => 1, x => 1, (x, t) => 0, (x, t) => x.X * x.X * x.X + 1, (x, t) => -6 * (x.X + x.Y)));
materials.Add("2", new Material(false, true, false, x => 1, x => 1, (x, t) => -3, (x, t) => 729 + x.Y * x.Y * x.Y, (x, t) => -6 * (x.X + x.Y)));
materials.Add("3", new Material(false, true, false, x => 1, x => 1, (x, t) => 216, (x, t) => x.X * x.X * x.X + 729, (x, t) => -6 * (x.X + x.Y)));
materials.Add("4", new Material(false, true, false, x => 1, x => 1, (x, t) => 0, (x, t) => 1 + x.Y * x.Y * x.Y, (x, t) => -6 * (x.X + x.Y)));
